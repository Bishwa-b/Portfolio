        ...
        <div className="grid md:grid-cols-2 place-items-center">
            <div>
                <div className="text-gray-300 my-3">
                    ...
                    I'm Biswa Ranjan Barik, a web developer from Hyderabad, TG, with a B.Tech in IT from KMIT, JNTU. Passionate about full-stack development, I've built projects from e-commerce platforms to AI-powered tools. I focus on creating responsive, user-friendly applications with clean code while constantly exploring new technologies.
                    </p>
                </div>
